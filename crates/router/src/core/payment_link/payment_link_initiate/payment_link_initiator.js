...
function initializeSDK() {
  ...
  var type = paymentDetails.sdk_layout === "spaced_accordion" || paymentDetails.sdk_layout === "accordion" ? "accordion" : paymentDetails.sdk_layout,
    ...
    layout: { type: type, /* accordion , tabs, spaced accordion */spacedAccordionItems: paymentDetails.sdk_layout === "spaced_accordion" },
    branding: "never",
    wallets: { walletReturnUrl: paymentDetails.return_url, style: {
        theme: "dark",
        type: "default",
        height: 55
      },
