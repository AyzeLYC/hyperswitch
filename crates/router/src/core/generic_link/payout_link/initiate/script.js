...
var payoutDetails = window.__PAYOUT_DETAILS,
    isTestMode = payoutDetails.test_mode,
...
if (!isTestMode && !isFramed) {
  ...
  function initializePayoutSDK() {
    ...
    var errMsg = "{{i18n_not_allowed}}",
        contentElement = document.getElementById("payout-link");
  ...
  **/
  function formatDate(date) {
    ...
    var months = ["{{i18n_january}}", "{{i18n_february}}", "{{i18n_march}}", "{{i18n_april}}", "{{i18n_may}}", "{{i18n_june}}", "{{i18n_july}}", "{{i18n_august}}", "{{i18n_september}}", "{{i18n_october}}", "{{i18n_november}}", "{{i18n_december}}", ];
  ...
  **/
  function initializePayoutSDK() {
    ...
    /* @ts-ignore */
    var payoutDetails = window.__PAYOUT_DETAILS,
        clientSecret = payoutDetails.client_secret,
        locale = payoutDetails.locale,
        publishableKey = payoutDetails.publishable_key,
        appearance = {
      variables: {
